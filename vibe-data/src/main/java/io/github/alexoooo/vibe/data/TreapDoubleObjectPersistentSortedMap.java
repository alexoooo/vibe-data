...
public final class TreapDoubleObjectPersistentSortedMap<T> implements DoubleObjectPersistentSortedMap<T> {
    ...
    private TreapDoubleObjectPersistentSortedMap(@Nullable Node<T> root, boolean descending, int size) {
        this.root = root;
        this.descending = descending;
        this.size = size;
    }

    public static <T> TreapDoubleObjectPersistentSortedMap<T> ascending() {
        return new TreapDoubleObjectPersistentSortedMap<>(null, false, 0);
    }

    public static <T> TreapDoubleObjectPersistentSortedMap<T> descending() {
        return new TreapDoubleObjectPersistentSortedMap<>(null, true, 0);
    }
    ...
    public Iterator<T> greaterOrEqualTo(double key) {
        return descending
                ? new DescendingIterator<>(root, key)
                : new AscendingIterator<>(root, key);
    }
    ...
    public TreapDoubleObjectPersistentSortedMap<T> remove(double key) {
        ...
        return new TreapDoubleObjectPersistentSortedMap<>(updatedRoot, descending, sizeOf(updatedRoot));
    }

    @Override
    public TreapDoubleObjectPersistentSortedMap<T> put(double key, T value) {
